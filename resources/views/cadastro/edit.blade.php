...
@section('content')
    ...
    <div class="container mt-5">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                placeholder="Digite seu nome" value="{{ $cadastros->name }}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline ">
                                <input class="form-check-input @error('sex') is-invalid @enderror" type="radio" name="sex"
                                    id="inlineRadio1" value="0" {{ $cadastros->sex == '0' ? 'checked' : '' }}>
                                <label class="form-check-label" for="inlineRadio1">Masculino</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input @error('sex') is-invalid @enderror" type="radio" name="sex"
                                    id="inlineRadio2" value="1" {{ $cadastros->sex == '1' ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="zip_code" class="form-control @error('zip_code') is-invalid @enderror"
                                name="zip_code" placeholder="Digite seu Cep" value="{{ $cadastros->zip_code }}">
                            @error('zip_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="100"
                                ...
                                placeholder="Complemento" value="{{ $cadastros->complement }}">
                            @error('complement')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('city') is-invalid @enderror" name="city"
                                placeholder="Cidade" value="{{ $cadastros->city }}">
                            @error('city')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror" name="email"
                                placeholder="Digite seu e-mail" value="{{ $cadastros->email }}">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="cellphone" class="form-control @error('cellphone') is-invalid @enderror"
                                name="cellphone" placeholder="Digite seu celular" value="{{ $cadastros->cellphone }}">
                            @error('cellphone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('birth_date') is-invalid @enderror"
                                name="birth_date" value="{{ $cadastros->birth_date }}">
                            @error('birth_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input @error('nationality') is-invalid @enderror" type="radio"
                                    name="nationality" id="inlineRadio3" onclick="javascript:mostraNacionalidade();"
                                    value="0" {{ $cadastros->nationality == '0' ? 'checked' : 'disabled' }}>
                                <label class="form-check-label" for="inlineRadio3">Brasileiro</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input @error('nationality') is-invalid @enderror" type="radio"
                                    name="nationality" id="inlineRadio4" onclick="javascript:mostraNacionalidade();"
                                    value="1" {{ $cadastros->nationality == '1' ? 'checked' : 'disabled' }}>
                        ...
                        <div class="form-group" id="cpff">
                            ...
                            <input type="text" id="cpf" class="form-control @error('cpf') is-invalid @enderror" name="cpf"
                                placeholder="Digite seu Cpf" value="{{ $cadastros->cpf }}">
                            @error('cpf')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group" id="passaporte">
                            ...
                            <input type="text" id="passport" class="form-control @error('cpf') is-invalid @enderror" name="passaporte"
                                placeholder="Digite seu Passaporte" name="passaporte"
                                value="{{ $cadastros->passaporte }}">
                            @error('passaporte')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group" id="rgg">
                            ...
                            <input type="text" id="rg" class="form-control @error('rg') is-invalid @enderror" name="rg"
                                placeholder="Digite seu RG" name="rg" value="{{ $cadastros->rg }}">
                            @error('rg')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('address') is-invalid @enderror" name="address"
                                placeholder="Digite seu endereço" value="{{ $cadastros->address }}">
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('number') is-invalid @enderror" name="number"
                                placeholder="Numero" value="{{ $cadastros->number }}">
                            @error('number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('district') is-invalid @enderror" name="district"
                                placeholder="Digite bairro" value="{{ $cadastros->district }}">
                            @error('district')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="state" class="form-control @error('state') is-invalid @enderror" id="1">
                                <option value="{{ $cadastros->state }}">{{ $cadastros->state }}</option>
                        ...
                        <br>
                        <input type="submit" name="submit" value="Confirmar Alteração" class="btn btn-primary"
                            style="float: right">
        ...
        <script>
            window.onload = function mostraNacionalidade() {
