...
@section('content')
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-sm-3 mt-2"><a href="{{ route('cadastros-create') }}" class="btn btn-success">Cadastre-se</a>
            </div>
        </div>
            ...
            <tbody>
                @foreach ($cadastros as $item)
                    <tr>
                        ...
                        <td class="d-flex"><a href="{{ route('cadastros-edit', ['id' => $item->id]) }}"
                        ...
                        <td>
                            <form action="{{ route('cadastros-destroy', ['id' => $item->id]) }}" method="POST">
                                @csrf
                                @method('DELETE')
